...
{ctrl:'sellerNumber',format:'phone',required:true}
  ...
  exports.routesConfig = function (app) {
      ...
      app.get('/redeem/all', [   //  Required to Fill UI Component like Dropdown ,List , can be disabled if not required
        ValidationMiddleware.validJWTNeeded,
        PermissionMiddleware.minimumPermissionLevelRequired(USER),
        RedeemController.listAll
    ]);
    app.get('/redeem/suggestions', [   //  Required to Fill UI Component like Auto Complete , can be disabled if not required
        ValidationMiddleware.validJWTNeeded,
        PermissionMiddleware.minimumPermissionLevelRequired(USER),
