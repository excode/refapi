...
{ctrl:'contactNumber',format:'phone',required:true}
  ...
  exports.routesConfig = function (app) {
      ...
      app.get('/sell/all', [   //  Required to Fill UI Component like Dropdown ,List , can be disabled if not required
        ValidationMiddleware.validJWTNeeded,
        PermissionMiddleware.minimumPermissionLevelRequired(USER),
        SellController.listAll
    ]);
    app.get('/sell/suggestions', [   //  Required to Fill UI Component like Auto Complete , can be disabled if not required
        ValidationMiddleware.validJWTNeeded,
        PermissionMiddleware.minimumPermissionLevelRequired(USER),
